  ...
  <body class="bg-light">
    ...
    <div class="container">
      ...
      <div class="col-md-12 order-md-1">
          ...
          <form class="needs-validation" method="post" action="checkBoat.php" enctype = "multipart/form-data" novalidate>
            <div class="row">
              <div class="col-md-12 mb-3">
                <label for="boatName">Boat name</label>
                <input type="text" class="form-control" id="boatName" name="boatName" placeholder="" value="" required>
            ...
            <div class="mb-3">
              ...
              <input type="number" step=0.01 class="form-control" min=0 id="length" name="length" placeholder="3.20" required>
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="type" name="type" placeholder="Guided Missile Frigate" required>
              <div class="invalid-feedback">
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit">Add a boat</button>
          </form>
        </div>
      </div>
